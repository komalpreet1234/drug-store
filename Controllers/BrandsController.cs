...
namespace DrugStoreManagement.Controllers
{
    public class BrandsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("BrandID,BrandName,Details")] Brand brand)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BrandID,BrandName,Details")] Brand brand)
        {
            if (id != brand.BrandID)
            {
                return NotFound();
